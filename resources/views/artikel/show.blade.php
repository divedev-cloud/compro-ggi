...
>
    ...
    <x-page-hero
        :title="$article->title"
        :breadcrumbs="[['label' => 'Artikel', 'url' => route('artikel.index')], ['label' => $article->title]]"
    />
        ...
        <div class="max-w-7xl mx-auto px-5 sm:px-8">
            ...
            <div class="lg:grid lg:grid-cols-[1fr_300px] xl:grid-cols-[1fr_320px] lg:gap-12 xl:gap-16">
                ...
                <div class="min-w-0">
                    ...
                    {{-- Meta bar --}}
                    <div class="flex flex-wrap items-center gap-4 text-sm text-ink-500 mb-8 pb-8 border-b border-ink-100 reveal">
                    ...
                    <div class="mt-14 pt-8 border-t border-ink-100 flex items-center justify-between reveal">
                        <a href="{{ route('artikel.index') }}"
                           class="inline-flex items-center gap-2 text-sm font-semibold text-ink-600 hover:text-cyan-600 transition-colors">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M19 12H5M12 6l-6 6 6 6"/></svg>
                ...
                <aside class="mt-14 lg:mt-0">
                    <div class="lg:sticky lg:top-28 space-y-5">
                        ...
                        <article class="glass-card group overflow-hidden flex gap-4 p-4 hover:-translate-y-0.5 transition-all duration-300">
                            ...
                            <a href="{{ route('artikel.show', $other->slug) }}"
                               class="flex-shrink-0 w-20 h-20 rounded-xl overflow-hidden bg-gradient-to-br from-cyan-500/10 to-violet-500/10">
                                ...
                                <div class="w-full h-full flex items-center justify-center">
                                    <svg class="w-6 h-6 text-cyan-600/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <h3 class="font-display font-600 text-sm text-ink-900 line-clamp-3 group-hover:text-cyan-600 transition-colors leading-snug">
                                    <a href="{{ route('artikel.show', $other->slug) }}">{{ $other->title }}</a>
                                </h3>
                            </div>
