            ...
            <div class="lg:col-span-5 reveal">
                ...
                <div class="glass-strong rounded-3xl p-5 sm:p-8 lg:p-9 lg:h-full">
                    ...
                    <div class="flex flex-wrap gap-2.5 sm:gap-3 mt-4">
                        <a href="https://www.instagram.com/gagasangemilangindonesia" target="_blank" rel="noopener" aria-label="Instagram" class="icon-circle hover:!shadow-glow-cyan"><svg
                        ...
                        <a href="https://www.youtube.com/@GagasanGemilangIndonesia" target="_blank" rel="noopener" aria-label="YouTube" class="icon-circle hover:!shadow-glow-cyan"><svg
                                width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2">
                                <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"/>
                                <polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"/>
                            </svg></a>
                        <a href="https://www.linkedin.com/in/pt-gagasan-gemilang-indonesia-575433418/" target="_blank" rel="noopener" aria-label="LinkedIn" class="icon-circle hover:!shadow-glow-cyan"><svg
                        ...
                        <a href="https://wa.me/6285333779893" target="_blank" rel="noopener" aria-label="WhatsApp" class="icon-circle hover:!shadow-glow-cyan"><svg
                                width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2">
                                <path
