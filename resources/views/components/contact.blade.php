<section id="contact" class="section-pad relative overflow-hidden">
    <div class="absolute top-0 left-1/4 w-96 h-96 bg-cyan-500/15 rounded-full blur-[130px] -z-10" aria-hidden="true"></div>
    <div class="absolute bottom-0 right-1/4 w-96 h-96 bg-gold-500/10 rounded-full blur-[130px] -z-10" aria-hidden="true"></div>

    <div class="max-w-7xl mx-auto px-5 sm:px-8">
        <div class="text-center max-w-2xl mx-auto mb-14 reveal">
            <span class="pill mb-6"><span class="pill-dot"></span>Mari Berkolaborasi</span>
            <h2 class="font-display font-700 text-4xl sm:text-5xl leading-tight mb-5">
                Hubungi <span class="text-gradient-aurora">Kami</span>
            </h2>
            <p class="text-ink-500">Diskusikan kebutuhan pengembangan ekonomi daerah Anda bersama tim GGI.</p>
        </div>

        <div class="grid lg:grid-cols-12 gap-8">

            <div class="lg:col-span-5 reveal-left">
                <div class="glass-strong rounded-3xl p-8 sm:p-9 h-full">
                    <div class="team-photo-ring w-20 h-20 mb-5">
                    ...
                    <p class="text-cyan-700 text-sm mb-8">Direktur / Lead Trainer</p>

                    <div class="space-y-5">
                        <a href="tel:+6285333779893" class="flex items-center gap-4 group">
                            <span class="icon-circle flex-shrink-0 group-hover:!shadow-glow-cyan"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92Z"/></svg></span>
                            <div>
                                <p class="text-xs text-ink-500">Telepon</p>
                                <p class="text-sm text-ink-900 font-medium">+62 853-3377-9893</p>
                            </div>
                        </a>

                        <div class="flex items-center gap-4">
                            <span class="icon-circle flex-shrink-0"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-10 7L2 7"/></svg></span>
                            <div>
                                <p class="text-xs text-ink-500">Email</p>
                                <p class="text-sm text-ink-900 font-medium">info@gagasangemilangindonesia.com</p>
                            </div>
                        </div>

                        <div class="flex items-center gap-4">
                            <span class="icon-circle flex-shrink-0"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15 15 0 0 1 0 20 15 15 0 0 1 0-20Z"/></svg></span>
                            <div>
                                <p class="text-xs text-ink-500">Instagram</p>
                                <p class="text-sm text-ink-900 font-medium">@gagasangemilangindonesia</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-4">
                            <span class="icon-circle flex-shrink-0"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg></span>
                            <div>
                                <p class="text-xs text-ink-500">Kantor</p>
                                <p class="text-sm text-ink-900 font-medium leading-snug">Bulus Wetan RT 02, Sumber Agung,<br/>Jetis, Bantul, D.I. Yogyakarta</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-3">
                        <a href="#" aria-label="Instagram" class="icon-circle hover:!shadow-glow-cyan"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37Z"/><path d="M17.5 6.5h.01"/></svg></a>
                        <a href="#" aria-label="WhatsApp" class="icon-circle hover:!shadow-glow-cyan"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5Z"/></svg></a>
                        <a href="#" aria-label="LinkedIn" class="icon-circle hover:!shadow-glow-cyan"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6Z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg></a>
                    </div>
                </div>
            </div>

            <div class="lg:col-span-7 reveal-right" data-delay="120">
                <form id="contact-form" action="{{ route('contact.send') }}" method="POST" class="glass-card p-8 sm:p-9 h-full">
                    @csrf
                    <div class="grid sm:grid-cols-2 gap-5 mb-5">
                        ...
                        <div>
                            <label for="org" class="block text-xs text-ink-500 mb-2">Instansi / Organisasi</label>
                    ...
                    <div class="grid sm:grid-cols-2 gap-5 mb-5">
                        ...
                        <div>
                            <label for="phone" class="block text-xs text-ink-500 mb-2">No. Telepon / WhatsApp</label>
