        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-10">
            ...
            <div class="lg:col-span-5 reveal">
                ...
                <div class="glass-strong rounded-3xl p-5 sm:p-8 lg:p-9 lg:h-full">
                    ...
                    <!-- Jarak vertikal yang disesuaikan (space-y-4 sm:space-y-5) -->
                    <div class="space-y-4 sm:space-y-5">

                        <!-- Telepon -->
                        <a href="tel:+6285333779893" class="flex items-center gap-3 sm:gap-4 group min-w-0">
                        ...
                        <div class="flex items-center gap-3 sm:gap-4 min-w-0">
                            ...
                            <div class="min-w-0 flex-1 overflow-hidden">
                                ...
                                <p class="text-sm text-ink-900 font-medium break-words">info@gagasangemilangindonesia.com</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3 sm:gap-4 min-w-0">
                            <span class="icon-circle flex-shrink-0 mt-0.5"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg></span>
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-sm text-ink-900 font-medium leading-relaxed">Bulus Wetan RT 02, Sumber Agung, Jetis, Bantul, D.I. Yogyakarta</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-7 reveal">
                ...
                <form id="contact-form" action="{{ route('contact.send') }}" method="POST" class="glass-card p-5 sm:p-8 lg:p-9 lg:h-full">
                    @csrf
